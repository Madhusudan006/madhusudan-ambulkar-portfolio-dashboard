...
with st.sidebar:
    ...
    st.markdown("""
        <div class="sidebar-link-container">
            <span>🔗</span> <a href="https://www.linkedin.com/in/madhusudan-ambulkar" target="_blank">LinkedIn</a>
        </div>
        <div class="sidebar-link-container">
            <span>💻</span> <a href="https://github.com/Madhusudan006" target="_blank">GitHub</a>
        </div>
